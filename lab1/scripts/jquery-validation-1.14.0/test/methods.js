...
*/
  ...
  test("extension", function () {
    ...
    method = function (value, param) {
      return $.validator.methods.extension.call(
        v,
        value,
        $("#text1")[0],
        param
...
*/
  ...
  test("nieES", function () {
    ...
    ok(
      !method("05.122.654-R"),
      "NIE inválido: starts with zero and dot and dash"
    );
  });
  ...
  test("postalCodeCA", function () {
    ...
    ok(
      !method("Z0H 0H"),
      "Invalid CA Postal Code; Only 'ABCEGHJKLMNPRSTVXY' are valid starting characters"
    );
    ok(
      !method("h0h 0h0"),
      "Invalid CA Postal Code; Only upper case characters"
    );
  });
